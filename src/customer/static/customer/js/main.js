(function($) {
  ...
  $(function() {
    $(".block-products-carousel").each(function() {
      ...
      const defaultItem = $(this).find(
        ".owl-carousel .block-products-carousel__column"
      );
        ...
        .on("click", function(event) {
          ...
          timer = setTimeout(function() {
            ...
            if (text === "Бүгд") {
              ...
              const newItem = defaultItem.get()[0];
              items = $(newItem);
            } else if (text === "Урамшуулалтай") {
              const discountItem = defaultItem.get()[1];
              items = $(discountItem);
            }
